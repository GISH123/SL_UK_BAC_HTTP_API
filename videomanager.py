...
class VideoManager(object):
            ...
            if not self.paused:
                ...
                if predictFlag and gmcode and isDetect:
                    ...
                    new_card_boxes, new_group_boxes, is_card_detected = self.process_frame(
                        frame, poslist, gmcode, detector, gmcode_show, frame_id
                    )
    ...
    def process_frame(self, frame, poslist, gmcode, detector, gmcode_show, frame_id):
        """
        ...
        logger.info(f"process_frame before posting, timestamp = {start_time}")
